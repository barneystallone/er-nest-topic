...
const KEYWORD_CONFIG_PATH = `${process.cwd()}/src/resources/sensitive-keyword.json`;
const logger = new Logger('DataMaskingHelper');

export const typeOf = (data: unknown) => Object.prototype.toString.call(data).slice(8, -1);
...
loadKeywords();
// logger.verbose(
//   DataMaskingHelper.makeSensitive([['abcdPassWORD123', 'abcd1234', 'acVVa'], 'secretKey is abc']),
//   // DataMaskingHelper.makeSensitive('abcdPassWORD123'),
//   // DataMaskingHelper.makeSensitive({
//   //   data: { personal: { myPassword1: '1234' } },
//   //   message: 'your CVV is 123',
//   //   status_code: 200,
//   // }),
// );
